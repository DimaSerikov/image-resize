...
class Creator
{
    ...
    private static function missingImageCreatePath(
        string $webroot,
        ?string $path,
        string $dir_name,
        ...
        if ($path !== null && is_file($path)) {
            ...
            $image_name = $silhouette === true ? self::DEFAULT_SILHOUETTE_NAME : self::DEFAULT_IMAGE_NAME;
            $orig_path = __DIR__ . '/images/' . $image_name;
            $dest_path = $webroot . self::$resizedBaseDir . '/' . $dir_name . '/' . $image_name;
        }
        return [$image_name, $orig_path, $dest_path];
    }
    ...
    public static function create(string $webroot, string $path): void
    {
        ...
        if (!is_file($orig_path)) {
            ...
            $path = $silhouette ? self::$defaultSilhouettePath : self::$defaultImagePath;
            [, $orig_path, $dest_path] = self::missingImageCreatePath($webroot, $path, $dir_name, $silhouette);
